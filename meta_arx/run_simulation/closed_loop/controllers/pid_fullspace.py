...
class PidFullspaceParams:
    coeffs: npt.ndarray
    
def load_pidfullspace_params_csv(path: str | Path) -> PidFullspaceParams:
    ...
    return PidFullspaceParams(coeffs = arr)


 
class PidFullspaceController:
    # Placeholder
    def __init__(self, params: PidFullspaceParams, dt: float) -> None:
        if dt <= 0:
